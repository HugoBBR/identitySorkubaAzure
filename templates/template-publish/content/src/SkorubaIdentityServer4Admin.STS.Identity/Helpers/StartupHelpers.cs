    ...
    public static class StartupHelpers
    {
            ...
            where TUserIdentity : class
        {
            ...
            var builder = services.AddIdentityServer(options => configurationSection.Bind(options))
                .AddConfigurationStore<TConfigurationDbContext>(options=>{options.DefaultSchema = "is4";})
                .AddOperationalStore<TPersistedGrantDbContext>(options=>{options.DefaultSchema = "is4";})
